...
<body>
	...
	<script>
		$(document).ready(function(){
			...
			function fetch(){
				var cnt = 1;
				$.ajax({
					url:"<?= base_url('admin/User_con/get_user'); ?>",
					type:"post",
					dataType:"json",
					...
					success:function(data){
						...
						$('#tbl').DataTable( {
					        ...
					        "columns": [
					            ...
					            return `<a href='#' class='btn btn-success' id='edit' value='${row.u_id}'>
				            				<i class="far fa-edit"></i></a>
				            			<a href='#' class='btn btn-danger' id='del' value='${row.u_id}'>
	...
	$(document).on("click", "#del", function(e){
        ...
        swalWithBootstrapButtons.fire({
          ...
          if (result.value) {
              ...
              $.ajax({
                url:"<?= base_url('admin/User_con/delete_user'); ?>",
                type: "post",
                dataType: "json",
                data: {
                  did:id
	...
	$(document).on("click", "#edit", function(e){
        ...
        $.ajax({
          url: "<?= base_url('admin/User_con/edit'); ?>",
          type: "post",
          dataType: "json",
          data: {
            eid:id
          ...
          success: function(data){
            ...
            if (data.response == "success") {
               ...
               $("#u_id").val(data.edituser.u_id);
                if(data.edituser.status == "active"){
	...
	$(document).on("click", "#update", function(e){
        ...
        var estatus = $("input[name='estatus']:checked").val();
          ...
          $.ajax({
            url: "<?= base_url('admin/User_con/update'); ?>",
            type: "post",
            dataType: "json",
            data: {
              	u_id:u_id,
            ...
            success: function(data){
	            ...
	            $('input:radio[name="estatus"]').filter('[value="active"]').attr('checked', false);
				$('input:radio[name="estatus"]').filter('[value="anactive"]').attr('checked', false);
            }
          });
    });
	</script>
